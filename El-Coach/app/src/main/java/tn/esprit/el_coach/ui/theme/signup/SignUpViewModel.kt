...
class SignUpViewModel(private val userRepository: UserRepository) : ViewModel() {
    ...
    fun signUpUser(name: String, email: String, password: String,image:String,phoneNumber:Int) {
        viewModelScope.launch {
            ...
            try {
                ...
                val response: Response<SignUpResponse> = userRepository.signUp(name, email, password,image,phoneNumber)
